c-----Al,N mass (to be multiplied by umass)
      real(8),parameter:: am_Al = 26.9815d0 *umass
      real(8),parameter:: am_N  = 14.0067d0 *umass
c-----J*m/C**2 ---> eV*Ang/e**2
c      real(8),parameter:: cfct= 8.9876d+9 *j2ev /ang
c     &     /(6.2414d+18)**2
...
c     &        2.6824d-17 *j2ev *1d0**v_n(2,1),
c     &        2.6824d-17 *j2ev *1d0**v_n(1,2),
     &        2.1790d-17 *j2ev *1d0**v_n(2,2) /)
