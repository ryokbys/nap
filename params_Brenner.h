...
c-----Brenner Carbon (in eV,Ang)
      ...
      real(8),parameter:: br_re = 1.315d-10 /ang
      real(8),parameter:: br_r1 = 1.7d-10 /ang
      real(8),parameter:: br_r2 = 2.0d-10 /ang
...
c-----interlayer potential by A.J.Heim et.al
      ...
      real(8),parameter:: c1vdw =-4.316677142326428d0
      real(8),parameter:: c2vdw = 1.376573417835169d0
      real(8),parameter:: c3vdw =-0.12340088128894569d0
