module Pellenq
!-----------------------------------------------------------------------
!                     Last modified: <2022-11-03 14:28:48 KOBAYASHI Ryo>
!-----------------------------------------------------------------------
...
!=======================================================================
  subroutine force_Pellenq(namax,natm,tag_isp,ra,nnmax,aa,strs,h,hi &
    ...
    if( l1st ) then
      if( allocated(strsl) ) then
        call accum_mem('force_Pellenq',-rp*size(strsl))
        deallocate(strsl)
      endif
