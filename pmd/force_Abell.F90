...
!.....Max number of species available in the potential
  integer:: nspcs
  real(rp):: abl_aij(nspmax,nspmax),abl_alpij(nspmax,nspmax)
  real(rp):: abl_bij(nspmax,nspmax),abl_betij(nspmax,nspmax)
...
contains
  subroutine force_Abell(namax,natm,tag_isp,ra,nnmax,aa,strs,h,hi &
...
!.....Set parameters
    ...
    call mpi_bcast(abl_alpij,nspmax*nspmax,mpi_real_rp,0,mpi_md_world,ierr)
    call mpi_bcast(abl_bij,nspmax*nspmax,mpi_real_rp,0,mpi_md_world,ierr)
    call mpi_bcast(abl_betij,nspmax*nspmax,mpi_real_rp,0,mpi_md_world,ierr)
