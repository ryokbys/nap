!-----------------------------------------------------------------------
!                     Last-modified: <2018-03-02 16:22:09 Ryo KOBAYASHI>
!-----------------------------------------------------------------------
program voids
!-----------------------------------------------------------------------
  ...
  do ix=1,nx
    do iy=1,ny
      do iz=1,nz
        ...
        iflag = -1
        if( n.eq.40082 ) then
          print *,'mx,my,mz,m,pi=',mx,my,mz,m,pi(1:3)
        endif
        do kuz=-1,1
          m1z = mz + kuz
          ...
          do kuy=-1,1
            ...
            do kux=-1,1
              ...
              if( n.eq.40082 ) then
                print *,'kux,kuy,kuz,m1x,m1y,m1z,m1='&
                     ,kux,kuy,kuz,m1x,m1y,m1z,m1
              endif
...
2             continue
              ...
              if( n.eq.40082 ) then
                print *,'n,m1,j,rij2,rc2,iflag=',&
                     n,m1,j,sqrt(rij2),rc,iflag
                print *,'pi,rtot=',pi(1:3),rtot(1:3,j)
              endif
              if( rij2.lt.rc2 ) then
                iflag = 0
                exit
