...
u"""
Make in.const.NN2 and in.params.NN2 to be used in NN2 potential.
"""

import sys,os,random

constfname='in.const.NN2'
paramfname='in.params.NN2'
...
g= open(paramfname,'w')
nc= (nsf+1)*nhl1 +(nhl1+1)*nhl2 +(nhl2+1)
