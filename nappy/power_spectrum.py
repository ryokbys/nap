...
data in pmd/dump files.

Usage:
  power_spectrum.py [options] INFILE [INFILE...]

Options:
  -h, --help   Show this help message and exit.
  --id ID      ID of an atom whose path is to be traced. [default: 1]
  -m, --measure MEASURE
               Num of measuring lane. In case of 1, it is identical to non-staggered measuring. [default: 1]
  -f, --file FILE
               File name which contains the list of IDs of atoms whose paths are to be traced. [default: None]
  --sid SID    Species-ID to be selected for power spectrum calculation. [default: 0]
  -s, --shift SHIFT
  ...
  --relax RELAX
               Relaxation time (fs) of decaying factor. [default: 1.0e+10]
"""
