...
c.....W-W
      ...
      real(8),parameter:: p_WW_c0   = 47.042512d0 *ev2hrt
      real(8),parameter:: p_WW_c1   = -33.987390d0 *ev2hrt /aa2bohr
      real(8),parameter:: p_WW_c2   = 6.319348d0 *ev2hrt/aa2bohr/aa2bohr
      real(8),parameter:: p_WW_B    = 90.300865d0 *ev2hrt
