...
rsync -avz --exclude="*.dSYM/" --exclude="subdir_*/" --exclude="doc/" --include="*/" --exclude="*.o" --exclude="*/*.mod" --exclude="*~" --exclude="makefile" --exclude="pmd" --exclude="fitpot" --exclude="*.pyc" --exclude="libpmd.a" ${src}/ ${dst}:src/nap/
