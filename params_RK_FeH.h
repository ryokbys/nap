...
!  Note that raw values are in AA and eV.
!-----------------------------------------------------------------------
...
!      real(8),parameter:: alcfe = 2.8553d-10 /bohr ! Ackland original
      real(8),parameter:: alcfe = 2.835d0 *aa2bohr
...
!.....Range in varphi
      real(8),parameter:: r1  = 1.0d0 *aa2bs
      real(8),parameter:: r2  = 2.0d0 *aa2bs
!.....Bs for r1 < r <= r2
...
!-----------------------------------------------------------------------
!.....Range in phi_FeH
      real(8),parameter:: r1_feh =  0.6d0 *aa2bohr
      real(8),parameter:: r2_feh =  1.2d0 *aa2bohr
!.....Bs for FeH
      real(8),parameter:: b0_feh = 1242.1709168218642d0
      real(8),parameter:: b1_feh =-6013.566711223783d0  /aa2bohr
      real(8),parameter:: b2_feh = 12339.540893927151d0 /aa2bohr**2
      real(8),parameter:: b3_feh =-12959.66163724488d0  /aa2bohr**3
      real(8),parameter:: b4_feh = 6817.850021676971d0  /aa2bohr**4
      real(8),parameter:: b5_feh =-1422.1723964897117d0 /aa2bohr**5
...
!.....r_phi_feh
     ...
     &     /)
!.....Cut off for phi_HH
      real(8),parameter:: rc_phi_hh  = 2.3d0 *aa2bohr
      real(8),parameter:: r0_hh      = 0.74d0 *aa2bohr
!.....S(r) for phi_HH
